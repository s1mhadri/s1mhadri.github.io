...
(function () {
  ...
  const bootLines = [
    ...
    { text: '[SYS] Loading modules: experience, projects, skills, education, contact, blog', delay: 600, class: 'dim-text' },
  ...
  const commandData = {
    ...
    '/blog': {
      summary: [
        'Thoughts on AI, computer vision, and building real things.',
        'Posts on detection pipelines, LLM agents, engineering practice, and more.'
      ],
      url: '/blog/',
